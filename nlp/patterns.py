...
pairs = [
    ...
    [r'(?i)(.*)(leody|.*guzman)(.*)(npa)(.*)',
     ['According to an article in Tsek.ph written by Akademiya at Bayan Kontra Disimpormasyon at Dayaan, Leody de Guzman is not a part of the New People\'s Army (NPA). He is an activist and workers\' leader. He also became the president of the Bukluran ng Manggagawang Pilipino.\n\n(https://www.tsek.ph/totoo-o-hindi-new-peoples-army-npa-member-nga-ba-si-ka-leody-de-guzman/)']],
    ...
    [r'(?i)(.*)(norberto|gonzales)(.*)(law)(.*)(rebellion)(.*)',
     ['The claim by Gonzales that there is no law against rebellion in the Philippines is false. The law is under Article 134-136, Title Three (Crimes Against Public Order), Chapter One (Rebellion, Sedition and Disloyalty) of the Revised Penal Code of the Philippines.\n\n(https://www.abs-cbn.com/news/02/18/22/fact-check-hindi-totoong-walang-batas-laban-sa-rebelyon)']],

    [r'(?i)(.*)(panfilo|ping|lacson)(.*)(executive)(.*)',
     ['The claim that Lacson did not serve under the executive branch is false. Lacson served under the Philippine National Police (PNP), which is under the executive department and part of the Department of Interior and Local Government (DILG) by virtue of Republic Act (RA) No. 6975, as amended by RA No. 8551, according to VERA FILES.\n\n(https://verafiles.org/articles/vera-files-fact-check-fb-post-falsely-claims-lacson-didnt-serve-under-executive-branch)']],

    [r'(?i)(.*)(bongbong|bbm|marcos)(.*)(bangui|windmills)(.*)',
     ['According to an article from Tsek.ph by UP sa Halalan 2022, the NorthWind Power Development Corporation (NPDC) led the creation of a 70-meter wind farm at Bangui Bay, Ilocos Norte in 2005. Bongbong Marcos supported the project as governor of Ilocos Norte.\n\n(https://www.tsek.ph/si-bongbong-marcos-ang-nanguna-sa-paggawa-ng-bangui-windmills-sa-pagudpud/)']],

    [r'(?i)(.*)(jose|joey|montemayor)(.*)(covid|vaccin.*)(.*)',
     ['According to a VERA FILES article, Montemayor is against mandatory vaccination. In addition, he claimed that the number of fully vaccinated individuals in the Philippines had not reached 30 million as of early March. His claim is false, according to data from the Department of Health (DOH) showing more than 63.30 million Filipinos had been vaccinated as of March 1.\n\n(https://verafiles.org/articles/vera-files-fact-check-presidential-aspirant-joey-montemayor)']],
    ...
    # Strictly bounded fake news regex (requires "corrupt" or "corruption", preventing government queries from getting hijacked)
    [r'(?i)(.*)((vp)?leni|robredo)(.*)(corrupt|corruption)(.*)',
