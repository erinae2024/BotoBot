...
pairs = [
    # ==========================================
    # 1. CANDIDATE LISTINGS & VOTING GUIDANCE
    # ==========================================
    
    # Candidate List Trigger
    [r'(?i).*(who|sino).*(candidate|kandidato|can i vote|to vote|pede iboto|pwede iboto).*|.*(who to vote|list of candidates|kandidato|mga kandidato|who are the candidates|who are candidates).*',
    ...
    [r'(?i).*(qualif|eligib|requirements to vote|who is eligible|can an 18).*(vote|voter).*|.*(vote|voter).*(qualif|eligib).*',
